      ...
      <footer className="flex w-full flex-col items-center justify-center dark:bg-dark-100">
        ...
        <section className="flex w-full items-center justify-center gap-8 p-8">
          ...
          <div className="flex flex-col items-center justify-center gap-4">
            <h3 className="text-lg font-bold text-primary-100 lg_2:text-base">
              Redes Sociais
            </h3>
        ...
        <p className="w-full bg-primary-100 py-1 text-center text-xs font-normal text-white lg_2:text-[10px]">
