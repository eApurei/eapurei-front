...
export default function AdditionalInformation() {
  return (
    <main className="flex flex-col items-center justify-center gap-6 px-8 py-4 dark:bg-grey-100">
      <div className="select-none rounded-md bg-primary-100 px-8 py-2 text-lg font-bold text-white">
      ...
      <section className="flex flex-col items-center justify-center gap-6 rounded-sm bg-primary-25 p-4">
        <div className="flex w-full flex-col items-start justify-center gap-2">
          ...
          <p className="text-sm font-normal">
            • A abertura sem sair de casa está disponível apenas para as cidades
            de Belo Horizonte, Curitiba, Florianópolis e São Paulo. Nessa
            modalidade, o processo de abertura é realizado pela eApurei.
          </p>
          <p className="text-sm font-normal">
            • O plano Experts Essencial comporta a emissão de até 35 notas
            fiscais por mês e o plano Experts Pro comporta até 70 notas fiscais
            por mês. Em caso de notas fiscais adicionais será cobrado R$8 por
            nota.
          </p>
          <p className="text-sm font-normal">
            • O plano Experts Pro comporta até 30 pagamentos por mês. Em caso de
            pagamentos adicionais, será cobrado o valor de R$6 por pagamento.
          </p>
          <p className="text-sm font-normal">
            • O plano Experts Essencial comporta até 2 contas bancárias e plano
            Experts Pro comporta o acompanhamento de até 3 contas bancárias.
            Para contas adicionais será cobrado R$29/mês por conta.
          </p>
        </div>
