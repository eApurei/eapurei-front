    ...
    >
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="relative overflow-hidden">
          <div className="hover:animate-pause flex w-fit animate-scroll">
          ...
          <div className="pointer-events-none absolute left-0 top-0 z-10 h-full w-20 bg-gradient-to-r from-gray-50 to-transparent dark:from-grey-100"></div>
